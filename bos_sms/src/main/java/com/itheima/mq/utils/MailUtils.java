...
public class MailUtils {
	...
	private static String password = "zuxucssnbofibfjc"; 
	private static String from = "747059574@qq.com"; // 使用当前账户 
	
	public static String activeUrl = "http://192.168.109.208:8080/bos_fore/customerAction_activeMail"; 
	...
	/*public static void main(String[] args) {
		sendMail("测试邮件", "你好，传智播客", "15552733337@sina.cn");
	}*/
}
