...
public class SmsUtil {
	...
	static final String accessKeyId = "LTAIKsncc6mjG2ab";
	static final String accessKeySecret = "oiyF1KZn6iwqtj0oD6sOPDUWVA87gI";

	public static SendSmsResponse sendSms(String telephone,String validateCode) throws ClientException {
		...
		// 必填:短信签名-可在短信控制台中找到
		request.setSignName("木快递");
		// 必填:短信模板-可在短信控制台中找到
		request.setTemplateCode("SMS_85495092");
		// 可选:模板中的变量替换JSON串,如模板内容为"亲爱的${name},您的验证码为${code}"时,此处的值为
		request.setTemplateParam("{\"number\":\""+validateCode+"\"}");
	...
	public void test01() throws ClientException{
		SendSmsResponse response = sendSms("15552733337","4755");
	}
