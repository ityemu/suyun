...
public class WayBill {
	...
	public WayBill(String goodsType, String sendProNum, String sendName, String sendMobile, String sendAddress,
			String recName, String recMobile, String recCompany, String recAddress) {
		super();
		this.sendName = sendName;
		this.sendMobile = sendMobile;
		this.sendAddress = sendAddress;
